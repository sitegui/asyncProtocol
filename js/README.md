...
## addBuffer(B)
Adds a Buffer to the bundle (Uint8Array).
...
Appends a array of Buffers (Uint8Array).
...
## new aP.Token([base])
Creates a new token from the base (another token or 16-byte buffer (Uint8Array)). Default: random token
